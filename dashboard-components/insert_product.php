...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $con->prepare("INSERT INTO products 
        (name, description, price, discount_price, stock, category, brand, rating, isTrendingCategory, isBestSeller, isNewArrival, isLimitedStock, views, sales_count, tags, image1, image2, image3) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0, 0, ?, ?, ?, ?)");
